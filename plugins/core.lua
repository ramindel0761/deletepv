...
[delete Team Channel](Telegram.Me/deleteTeam)
_Good Luck_ *:D*
...
local start_key = {{{text="👤ارتباط با ما",url="https://telegram.me/deleteTeam"}}}
...
if matches[1] == "delete" or matches[1] == "🎯اعضای تیم"  then
